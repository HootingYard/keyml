...
This tests that Big Book of Key XHTML files:
    ...
    (a) match a DTD, typically keyml.dtd;

    (b) pass a set of Schematron tests, typically in keyml.sch;
...
class Settings:
    ...
    def __init__(self):
        ...
        self.verbose = False
        self.files = []
        self.dtd = Path(__file__).parent / 'keyml.dtd'
        self.schematron = Path(__file__).parent / 'keyml.sch'
